...
if(isset($_GET['search'])){
    ...
    $stmt = mysqli_query($conn, "SELECT * FROM `books` WHERE title LIKE '$searchQuery'OR author LIKE '$searchQuery'");
    $books = mysqli_fetch_all($stmt, MYSQLI_ASSOC);

    if(!$books) {
        $error = "No book with Title: " . $searchQuery . " or Author: " . $searchQuery . " exist in the database";
    }
